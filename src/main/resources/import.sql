...
INSERT INTO TB_CPSB_BREED (nm_breed, ds_breed) VALUES ( 'Pastor-alemão', 'Sua pelagem — de sub-pelo denso e acinzentado — em questão de cor varia em: pelagem bicolor marrom (avermelhado ou amarelado) com capa preta; pelagem bicolor Melanistico (quase inteiramente preto com patas e outras marcas castanhas; pelagem unicolor totalmente preta; e pelagem Sable (agouti) em suas infinitas tonalidades desde o "cinza negro, ou prateado, passando pelo cinza dourado e o avermelhado, sendo as marcações podendo ser uniformes, em mantos ou encarvoados. Sempre deve possuir máscara preta e nariz preto.');
INSERT INTO TB_CPSB_BREED (nm_breed, ds_breed) VALUES ( 'Poodle', 'Fisicamente, o tamanho do poodle varia entre o grande e o toy, tendo, em seus exemplares maiores, os mais bondosos, submissos e saudáveis, com a adenite sebácea sendo classificada como sua principal enfermidade. As qualidades físicas do padrão standard o tornaram um bom cão de companhia para famílias que vivem em grandes áreas, como fazendas.');

INSERT INTO TB_CPSB_PET (nm_pet, id_breed) VALUES ('Brendan', 1);
INSERT INTO TB_CPSB_PET (nm_pet, id_breed) VALUES ('Rex', 4);
INSERT INTO TB_CPSB_PET (nm_pet, id_breed) VALUES ('Toby', 3);
INSERT INTO TB_CPSB_PET (nm_pet, id_breed) VALUES ('Spike', 2);

INSERT INTO TB_CPSB_ROLE (nm_role) VALUES ( 'ROLE_ADMIN' );
INSERT INTO TB_CPSB_ROLE (nm_role) VALUES ( 'ROLE_USER' );

INSERT INTO TB_CPSB_USER (nm_username, ds_password) VALUES ( 'Gabriel', '$2y$08$OzTn1weNsLrAe2HGsvmt.uOYduu0Yi2yZ6ZlaHJxK.s/.nD2.Uoda' ); // 12345
INSERT INTO TB_CPSB_USER (nm_username, ds_password) VALUES ( 'Michelle', '$2y$08$OzTn1weNsLrAe2HGsvmt.uOYduu0Yi2yZ6ZlaHJxK.s/.nD2.Uoda' ); // 12345
INSERT INTO TB_CPSB_USER (nm_username, ds_password) VALUES ( 'João Pedro', '$2y$08$OzTn1weNsLrAe2HGsvmt.uOYduu0Yi2yZ6ZlaHJxK.s/.nD2.Uoda' ); // 12345

INSERT INTO TB_CPSB_USER_ROLE (id_user, id_role) VALUES ( 1, 1 );
INSERT INTO TB_CPSB_USER_ROLE (id_user, id_role) VALUES ( 2, 1 );
INSERT INTO TB_CPSB_USER_ROLE (id_user, id_role) VALUES ( 3, 2 );
